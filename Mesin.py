...
st.title("📋 Manajemen Data Sheet 'Mesin'")

def run():
    # ============================
    # 1. Tampilkan isi Sheet "Mesin"
    # ============================
    st.subheader("📄 Data di Sheet 'Mesin'")
    ...
    # ============================
    st.subheader("➕ Tambah Baris Baru ke Sheet 'Mesin'")
    ...
    # ============================
    st.subheader("❌ Hapus Baris dari Sheet 'Mesin'")
